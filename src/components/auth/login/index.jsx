  ...
  return (
    <div>
      ...
      <main className="w-full primary-height flex self-center place-content-center place-items-center">
        <div className="w-96 text-gray-700 space-y-5 p-4 shadow-xl border rounded-xl">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              {/* <input
                ...
                className="w-full mt-1 px-3 py-2 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"
              /> */}
              <Input
                clearable
                label="Email"
            ...
            <button
              type="submit"
              disabled={isSigningIn || !email || !password || !isEmailValid} // Disables the button if email or password is empty or if the email is not valid
              className={`w-full px-4 py-2 text-white font-medium rounded-lg ${
                isSigningIn || !email || !password || !isEmailValid
          ...
          <p className="text-center text-sm font-roboto-condensed">
          ...
          <div className="flex flex-row text-center w-full">
            ...
            <div className="text-sm font-roboto-condensed font-bold w-fit">
              OR
            </div>
